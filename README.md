...
1. **Clone or copy the files** into your Google Cloud Platform (GCP) Virtual Machine.
...
5. **Access the application**: Open your web browser and navigate to `http://<YOUR_GCP_VM_EXTERNAL_IP>:8080`.
